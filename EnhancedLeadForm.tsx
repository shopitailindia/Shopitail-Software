    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-white mb-4">Get Your Free Demo & Custom Quote</h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Our team will call you within 2 hours to understand your needs and show you ASTER live.
          </p>
        </motion.div>
          ...
          <div className="md:col-span-3">
            <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 text-neutral-900">
              ...
              >
                ...
                <h3 className="mb-5 text-xl font-semibold">Request Your Free Demo</h3>
                ...
                <input name="email" type="email" placeholder="Email Address" className="input mt-4" />
